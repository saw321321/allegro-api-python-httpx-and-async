...
class AsyncPromotionsResource(AsyncBaseResource):
    """Async Resource for promotions, badges, and marketing campaigns."""
    ...
    async def get_promotions(
        ...
        return await self.client.get("/sale/loyalty/promotions", params=params)
    ...
    async def create_promotion_campaign(
        ...
        return await self.client.post("/sale/loyalty/promotion-campaigns", json_data=data)
    
    async def get_promotion_campaign(self, campaign_id: str) -> Dict[str, Any]:
        """
        Get promotion campaign details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/sale/loyalty/promotion-campaigns/{campaign_id}")
    ...
    async def delete_promotion_campaign(self, campaign_id: str) -> None:
        """
        Delete promotion campaign.
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/sale/loyalty/promotion-campaigns/{campaign_id}")
    
    # Badge Campaigns
    async def get_badge_campaigns(
        self,
        offer_id: Optional[str] = None,
        limit: int = 50,
        offset: int = 0,
        ...
        return await self.client.get("/sale/badge-campaigns", params=params)
    
    async def get_badge_applications(
        self,
        campaign_id: Optional[str] = None,
        offer_id: Optional[str] = None,
        status: Optional[str] = None,
        ...
        return await self.client.get("/sale/badge-applications", params=params)
    
    async def create_badge_application(
        self,
        campaign_id: str,
        offer_id: str,
        prices: Optional[Dict[str, Any]] = None,
        ...
        return await self.client.post("/sale/badge-applications", json_data=data)
    
    async def get_badge_application(self, application_id: str) -> Dict[str, Any]:
        """
        Get badge application details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/sale/badge-applications/{application_id}")
    
    async def update_badge_application(
        self,
        application_id: str,
        prices: Dict[str, Any],
    ) -> Dict[str, Any]:
    ...
    async def delete_badge_application(self, application_id: str) -> None:
        """
        Delete badge application.
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/sale/badge-applications/{application_id}")
    
    # Allegro Prices
    async def get_allegro_prices_eligibility(self, offer_id: str) -> Dict[str, Any]:
        """
        Check offer eligibility for Allegro Prices.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/sale/allegro-prices-offer-eligibility/{offer_id}")
    
    async def get_allegro_prices_consent(self) -> Dict[str, Any]:
        """
        Get Allegro Prices consent status.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get("/sale/allegro-prices-eligibility")
    
    async def update_allegro_prices_consent(self, consent: bool) -> Dict[str, Any]:
        """
        Update Allegro Prices consent.
    ...
    async def get_discounts(
        ...
        return await self.client.get("/sale/discounts", params=params)
    ...
    async def get_bundles(
        ...
        return await self.client.get("/sale/offer-bundles", params=params)
    ...
    async def create_bundle(
        ...
        return await self.client.post("/sale/offer-bundles", json_data=data)
    ...
    async def get_bundle(self, bundle_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/sale/offer-bundles/{bundle_id}")
    ...
    async def update_bundle(
        ...
        return await self.client.put(f"/sale/offer-bundles/{bundle_id}", json_data=data)
    ...
    async def delete_bundle(self, bundle_id: str) -> None:
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/sale/offer-bundles/{bundle_id}")