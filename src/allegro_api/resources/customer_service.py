...
class AsyncCustomerServiceResource(AsyncBaseResource):
    """Async Resource for customer service operations."""
    
    # Post Purchase Issues
    async def get_post_purchase_issues(
        self,
        status: Optional[List[str]] = None,
        order_id: Optional[str] = None,
        buyer_login: Optional[str] = None,
        ...
        return await self.client.get("/order/issues", params=params)
    ...
    async def get_issue(self, issue_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/issues/{issue_id}")
    
    async def get_issue_messages(self, issue_id: str) -> Dict[str, Any]:
        """
        Get issue messages.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/issues/{issue_id}/messages")
    
    async def send_issue_message(
        self,
        issue_id: str,
        text: str,
        attachments: Optional[List[Dict[str, Any]]] = None,
    ...
    async def get_thread(self, thread_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/messaging/threads/{thread_id}")
    ...
    async def mark_thread_as_read(self, thread_id: str) -> None:
        """
        Mark thread as read.
        ...
        """
        await self._ensure_authenticated()
        await self.client.put(f"/messaging/threads/{thread_id}/read")
    ...
    async def get_message_templates(
        ...
        return await self.client.get("/messaging/templates", params=params)
    ...
    async def get_contacts(self) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get("/after-sales-service-conditions/contacts")
    ...
    async def get_contact(self, contact_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/after-sales-service-conditions/contacts/{contact_id}")
