...
class AsyncProductsResource(AsyncBaseResource):
    ...
    async def search(
        ...
        return await self.client.get("/sale/products", params=params)
    
    async def get(self, product_id: str, category_id: Optional[str] = None) -> Dict[str, Any]:
        """
        Get product details.
        ...
        return await self.client.get(f"/sale/products/{product_id}", params=params)
    ...
    async def get_proposals(
        ...
        return await self.client.get("/sale/product-proposals", params=params)
    ...
    async def create_proposal(
        ...
        return await self.client.post("/sale/product-proposals", json_data=data)
    ...
    async def get_proposal(self, proposal_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/sale/product-proposals/{proposal_id}")
    ...
    async def delete_proposal(self, proposal_id: str) -> None:
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/sale/product-proposals/{proposal_id}")
    ...
    async def get_my_products(
        ...
        return await self.client.get("/sale/products/my-products", params=params)
    ...
    async def match_product(
        ...
        return await self.client.post("/sale/products/match", json_data=data)
    
    async def get_compatibility_list(self, product_id: str, category_id: str) -> Dict[str, Any]:
        """
        Get product compatibility list.
        ...
        """
        params = {"category.id": category_id}
        return await self.client.get(f"/sale/products/{product_id}/compatibility-list", params=params)
    ...
    async def get_change_proposals(
        ...
        return await self.client.get("/sale/product-change-proposals", params=params)
    ...
    async def create_change_proposal(
        ...
        return await self.client.post("/sale/product-change-proposals", json_data=data)