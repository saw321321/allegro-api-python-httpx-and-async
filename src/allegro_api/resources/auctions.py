...
#Async Auctionresource

class AsyncAuctionsResource(AsyncBaseResource):
    """Async Resource for auction and bidding operations."""
    ...
    async def get_my_bids(
        ...
        return await self.client.get("/bidding/my-bids", params=params)
    ...
    async def place_bid(
        ...
        return await self.client.post("/bidding/bids", json_data=data)
    
    async def get_auction_events(
        self,
        from_id: Optional[str] = None,
        type_: Optional[List[str]] = None,
        limit: int = 100,
        ...
        return await self.client.get("/bidding/auction-events", params=params)
    ...
    async def get_bidding_history(
        ...
        return await self.client.get(f"/bidding/auctions/{auction_id}/history", params=params)
    ...
    async def get_won_auctions(
        ...
        return await self.client.get("/bidding/won-auctions", params=params)
    
    async def get_auction_offers(
        self,
        status: Optional[List[str]] = None,
        publication_status: Optional[List[str]] = None,
        ending_at_gte: Optional[datetime] = None,
        ...
        return await self.client.get("/sale/auction-offers", params=params)
    
    async def get_watching_auctions(
        self,
        status: Optional[str] = None,
        sort: Optional[str] = None,
        limit: int = 50,
        ...
        return await self.client.get("/bidding/watching", params=params)
    
    async def watch_auction(self, auction_id: str) -> Dict[str, Any]:
        """
        Add auction to watchlist.
        ...
        return await self.client.post("/bidding/watching", json_data=data)
    
    async def unwatch_auction(self, auction_id: str) -> None:
        """
        Remove auction from watchlist.
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/bidding/watching/{auction_id}")
    
    async def get_bid_info(self, auction_id: str) -> Dict[str, Any]:
        """
        Get bid information for auction.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/bidding/auctions/{auction_id}/bid-info")
    
    async def cancel_bid(self, bid_id: str, reason: str) -> Dict[str, Any]:
        """
        Cancel bid.
        ...
        return await self.client.post(f"/bidding/bids/{bid_id}/cancel", json_data=data)