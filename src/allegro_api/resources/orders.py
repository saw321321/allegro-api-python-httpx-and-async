...
class AsyncOrdersResource(AsyncBaseResource):
    ...
    async def list(
        ...
        return await self.client.get("/order/checkout-forms", params=params)
    ...
    async def get(self, order_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/checkout-forms/{order_id}")
    ...
    async def get_events(
        ...
        return await self.client.get("/order/events", params=params)
    ...
    async def get_shipments(self, order_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/checkout-forms/{order_id}/shipments")
    ...
    async def get_invoices(self, order_id: str) -> Dict[str, Any]:
        """
        Get order invoices.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/checkout-forms/{order_id}/invoices")
    ...
    async def get_refunds(self, order_id: str) -> Dict[str, Any]:
        """
        Get order refunds.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/checkout-forms/{order_id}/refunds")
    ...
    async def get_returns(
        ...
        return await self.client.get("/after-sales-service-conditions/returns", params=params)
    ...
    async def get_return(self, return_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/after-sales-service-conditions/returns/{return_id}")