...
class AsyncPaymentsResource(AsyncBaseResource):
    ...
    async def get_payment_operations(
        ...
        return await self.client.get("/payments/payment-operations", params=params)
    ...
    async def get_payment_operation(self, operation_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/payments/payment-operations/{operation_id}")
    ...
    async def get_payment_history(
        ...
        return await self.client.get("/payments/payment-history", params=params)
    ...
    async def initiate_refund(
        ...
        return await self.client.post("/payments/refunds", json_data=data)
    ...
    async def get_refunds(
        ...
        return await self.client.get("/payments/refunds", params=params)
    ...
    async def get_refund(self, refund_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/payments/refunds/{refund_id}")
    
    async def get_surcharges(
        self,
        order_id: Optional[str] = None,
        status: Optional[str] = None,
        created_at_gte: Optional[datetime] = None,
        ...
        return await self.client.get("/payments/surcharges", params=params)
    ...
    async def create_surcharge(
        ...
        return await self.client.post("/payments/surcharges", json_data=data)
    ...
    async def get_wallets(
        ...
        return await self.client.get("/payments/wallets", params=params)
    ...
    async def get_wallet(self, wallet_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/payments/wallets/{wallet_id}")
    ...
    async def get_wallet_balance(self, wallet_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/payments/wallets/{wallet_id}/balance")