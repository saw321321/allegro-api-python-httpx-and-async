...
class AsyncBillingResource(AsyncBaseResource):
    """Async Resource for billing operations."""
    ...
    async def get_billing_entries(
        ...
        return await self.client.get("/billing/billing-entries", params=params)
    
    async def get_billing_entry(self, entry_id: str) -> Dict[str, Any]:
        """
        Get billing entry details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/billing/billing-entries/{entry_id}")
    
    async def get_billing_types(self) -> Dict[str, Any]:
        """
        Get available billing types.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get("/billing/billing-types")
    
    async def get_commission_refunds(
        self,
        order_id: Optional[str] = None,
        created_at_gte: Optional[datetime] = None,
        created_at_lte: Optional[datetime] = None,
        ...
        return await self.client.get("/order/refund-claims", params=params)
    ...
    async def create_commission_refund(
        ...
        return await self.client.post(f"/order/refund-claims", json_data=data)
    
    async def get_commission_refund(self, claim_id: str) -> Dict[str, Any]:
        """
        Get commission refund claim details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/order/refund-claims/{claim_id}")
    
    async def cancel_commission_refund(self, claim_id: str) -> None:
        """
        Cancel commission refund claim.
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/order/refund-claims/{claim_id}")
    ...
    async def get_balance(self) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get("/account/balance")
    ...
    async def get_operations_history(
        ...
        return await self.client.get("/account/operations-history", params=params)