...
class AsyncFulfillmentResource(AsyncBaseResource):
    """Async Resource for One Fulfillment operations."""
    
    # Advance Ship Notices
    async def get_advance_ship_notices(
        self,
        status: Optional[str] = None,
        created_at_gte: Optional[datetime] = None,
        created_at_lte: Optional[datetime] = None,
        ...
        return await self.client.get("/fulfillment/advance-ship-notices", params=params)
    ...
    async def create_advance_ship_notice(
        ...
        return await self.client.post("/fulfillment/advance-ship-notices", json_data=data)
    
    async def get_advance_ship_notice(self, notice_id: str) -> Dict[str, Any]:
        """
        Get advance ship notice details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/fulfillment/advance-ship-notices/{notice_id}")
    
    async def update_advance_ship_notice(
        self,
        notice_id: str,
        items: Optional[List[Dict[str, Any]]] = None,
        labels: Optional[List[Dict[str, Any]]] = None,
    ...
    async def submit_advance_ship_notice(self, notice_id: str) -> Dict[str, Any]:
        """
        Submit advance ship notice for processing.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.post(f"/fulfillment/advance-ship-notices/{notice_id}/submit")
    
    async def get_advance_ship_notice_labels(self, notice_id: str) -> bytes:
        """
        Get advance ship notice labels PDF.
    ...
    async def get_stock_levels(
        ...
        return await self.client.get("/fulfillment/stock", params=params)
    ...
    async def get_stock_movements(
        ...
        return await self.client.get("/fulfillment/stock-movements", params=params)
    ...
    async def get_parcels(
        ...
        return await self.client.get("/fulfillment/parcels", params=params)
    ...
    async def get_parcel(self, parcel_id: str) -> Dict[str, Any]:
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/fulfillment/parcels/{parcel_id}")
    
    async def get_parcel_tracking(self, parcel_id: str) -> Dict[str, Any]:
        """
        Get parcel tracking information.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/fulfillment/parcels/{parcel_id}/tracking")
    ...
    async def get_fulfillment_products(
        ...
        return await self.client.get("/fulfillment/products", params=params)
    
    async def create_fulfillment_product(
        self,
        offer_id: str,
        dimensions: Dict[str, Any],
        weight: Dict[str, Any],
        ...
        return await self.client.post("/fulfillment/products", json_data=data)
    
    async def update_fulfillment_product(
        self,
        product_id: str,
        dimensions: Optional[Dict[str, Any]] = None,
        weight: Optional[Dict[str, Any]] = None,
        ...
        return await self.client.put(f"/fulfillment/products/{product_id}", json_data=data)
    ...
    async def get_removal_requests(
        ...
        return await self.client.get("/fulfillment/removal-requests", params=params)
    ...
    async def create_removal_request(
        ...
        return await self.client.post("/fulfillment/removal-requests", json_data=data)
    
    async def get_removal_request(self, request_id: str) -> Dict[str, Any]:
        """
        Get removal request details.
        ...
        """
        await self._ensure_authenticated()
        return await self.client.get(f"/fulfillment/removal-requests/{request_id}")
    
    async def cancel_removal_request(self, request_id: str) -> None:
        """
        Cancel removal request.
        ...
        """
        await self._ensure_authenticated()
        await self.client.delete(f"/fulfillment/removal-requests/{request_id}")